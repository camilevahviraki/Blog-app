...
RSpec.describe 'Users_Index', type: :feature do
  subject do
    User.new(Name: 'camilux', Photo: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSQx5pB6py4twIFGBfFT4IS8E13iYj_pzGyKw&usqp=CAU',
             Bio: 'kefjwckllkl', PostsCounter: 0)
  end
